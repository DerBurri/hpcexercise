...
def main():
    ...
    parser.add_argument('--pruning-rate', type=float, default=0.2, metavar='P',help='pruning rate')
    ...
    print(f'Pruning rate: {args.pruning_rate}')
    ...
    parameters_to_prune = (
    (model.conv1, 'weight'),
    (model.block1_1.conv1, 'weight'),
    (model.block1_2.conv2, 'weight'),
    (model.block1_2.conv1, 'weight'),
    (model.block1_3.conv1, 'weight'),
    (model.block1_3.conv2, 'weight'),
    (model.block2_1.conv1, 'weight'),
    (model.block2_1.conv2, 'weight'),
    (model.block2_2.conv1, 'weight'),
    (model.block2_2.conv2, 'weight'),
    (model.block2_3.conv1, 'weight'),
    (model.block2_3.conv2, 'weight'),
    (model.fc1, 'weight'),
)

    for module, name in parameters_to_prune:
        prune.ln_structured(module, name, amount=args.pruning_rate, n=2, dim=0)
        prune.remove(module, name)

    print("Pruning rate", args.pruning_rate)
    print("Total Bops", model.calculate_bops())
    ...
    with open(f'results_resnet18_structured_pruned{args.pruning_rate}.csv', mode='w', newline='') as file:
